...
import com.maxcloud.keyboard.latin.common.UnicodeSurrogate;
import com.maxcloud.keyboard.latin.settings.SpacingAndPunctuations;
import com.maxcloud.keyboard.latin.utils.CapsModeUtils;
import com.maxcloud.keyboard.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.maxcloud.keyboard.latin.common.Constants.UnicodeSurrogate
